...
public:
    ...
    // IA del tablero - devuelve el mejor movimiento para OSCURIDAD
    bool calcularMovimientoIA(int& filaOrigen, int& colOrigen, int& filaDest, int& colDest);
    //prueba
    void setDestinoIA(int f, int c) { filaDestinoIA = f; colDestinoIA = c; mostrarDestinoIA = true; }
    void ocultarDestinoIA() { mostrarDestinoIA = false; }
